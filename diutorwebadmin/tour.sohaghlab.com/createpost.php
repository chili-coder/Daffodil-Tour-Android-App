            ...
            <div class="sidebar-manu">
                ...
                <ul>
                   <li>
                    ...
                    <li>
                        <a href="blogpost.php" class="active"><span class="las la-pen"></span><span>Blog Post</span> </a>
                     </li>
                     <li>
...
<section class="mb-4">
    ...
    <!--Section heading-->
    <h2 class="h1-responsive font-weight-bold text-center my-4">New Post</h2>
    <!--Section description-->
    <p class="text-center w-responsive mx-auto mb-5">Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within
        ...
        <div class="col-md-9 mb-md-0 mb-5">
            <form id="contact-form" method ="POST" action =" " name="contact-form">
                ...
                <!--Grid row-->
                            ...
                            <span class="input-group-btn">
                                <span class="btn btn-default btn-file">
                                    <input type="file" name="pimage" id="imgInp">
                                </span>
                            </span>
                ...
                <!--Grid row-->
                    ...
                    <div class="col-md-12">
                        <div class="md-form mb-0">
                            ...
                            <input type="text" id="subject" name="ptitle" class="form-control">
                ...
                <!--Grid row-->
                    ...
                    <div class="col-md-12">
                        <div class="md-form">
                            ...
                            <textarea type="text" id="message" name="post"  class="form-control md-textarea"></textarea>
                ...
                <div class="col-md-12">
                    <div class="md-form mb-0">
                        <label for="subject" class="">Location</label>
                        <input type="text" id="subject" name="plocation" class="form-control">
                ...
                <div class="col-md-12">
                    <div class="md-form mb-0">
                        ...
                        <input type="date" id="subject" name="pdate" class="form-control">
                        <label ></label>
            ...
            <div class="text-center text-md-center">
                <a class="btn btn-success " name="psubmit" >Submit</a>
            </div>
            <div class="status">
                <a href="blogpost.php" class="text-success"><label> Back to Post</label></a>
            </div>
        </div>
        <!--Grid column-->
