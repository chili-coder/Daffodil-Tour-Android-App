                ...
                <ul>
                   <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="approved.php" class="active"><span class="las la-check-square"></span> <span>Approved for Tour</span></a>
                     </li>
                     <li>
...
<div class="container1">
 <div class="card">
    <div class="row">
        <div class="accept"><i class="las la-check-circle"></i></div>
      ...
      <div class="col-md-6 details">
          ...
          <br>
          <small> Location: <label> Cox's Bazar </label></small><br>
          <small> T-shart Size: <label > M </label></small><br>
          <small> Food Token: <label> Ok </label></small><br>
          <small> Others: <label> Ok </label></small><br>
